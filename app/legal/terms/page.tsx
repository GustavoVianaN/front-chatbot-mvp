  ...
  return (
    <main className="min-h-screen bg-slate-950 p-8 text-slate-200">
      <article className="mx-auto max-w-3xl prose prose-invert">
        ...
        <p>
          Novas contas recebem um crédito gratuito único de até 100 respostas da Bella, sem custo
          e sem necessidade de cartão de crédito. Esse crédito não tem prazo de validade e não se
          renova mensalmente. Ao atingir o limite de respostas, é necessário selecionar um plano
          pago para continuar usando o atendimento automatizado sem interrupção.
        </p>
        ...
        <p>
          ...
          produtos e configurações inseridos na plataforma. A BellAI Connect mantém a titularidade sobre
