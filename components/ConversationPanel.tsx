...
export default function ConversationPanel({ conversation, onReply, onUpdateStatus, onToggleBot }: ConversationPanelProps) {
  ...
  if (!conversation) {
    return <div className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4 text-slate-400 sm:rounded-3xl sm:p-8">Selecione uma conversa para visualizar aqui.</div>;
  }
